                    ...
                    <table className="w-full border-collapse text-left">
                        <thead>
                            <tr className="bg-[#1e40af]">
                                <th className="border border-[#1e3a8a] px-6 py-4 text-[10px] font-black uppercase tracking-widest text-white">
                                    Borrower
                                </th>
                                <th className="border border-[#1e3a8a] px-6 py-4 text-[10px] font-black uppercase tracking-widest text-white">
                                    Contact & Email
                                ...
                                >
                                    <td className="border border-slate-200 px-6 py-4">
                                        <div className="flex items-center gap-3">
                                            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-slate-100 text-xs font-black uppercase text-[#1e40af]">
                                                {b.last_name?.[0]}
                                                {b.first_name?.[0]}
                                            </div>
                                            <div>
                                                ...
                                                <p className="font-mono text-[10px] text-slate-400">{b.rfidId}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="border border-slate-200 px-6 py-4">
                                        <div className="space-y-1">
                                            ...
                                            <div className="flex items-center gap-2 text-[10px] italic text-slate-400">{b.email || "No email"}</div>
                                        </div>
                                    </td>
                                    <td className="border border-slate-200 px-6 py-4">
                                        <div className="flex max-w-[200px] items-start gap-2">
                                            ...
                                            />
                                            <p className="line-clamp-2 text-[10px] font-medium uppercase leading-tight text-slate-600">
                ...
                <div className="flex items-center justify-between border-t border-slate-200 bg-slate-50/50 px-6 py-4">
                    ...
                    <div className="flex gap-2">
                        <button
                            ...
                            className="flex h-8 items-center gap-1 rounded-lg border border-slate-200 bg-white px-3 text-[9px] font-black uppercase disabled:opacity-30"
                        >
                    ...
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                        ...
                        >
                            <div className="flex flex-col items-center text-center">
                                ...
                                <h3 className="text-xl font-black uppercase text-[#1e40af]">Confirm Delete</h3>
                                ...
                                <div className="flex w-full gap-2">
                                    <button
                                        onClick={() => setIsDeleteModalOpen(false)}
                                        className="flex-1 rounded-xl bg-slate-100 py-3 text-[10px] font-black uppercase text-slate-400"
                                    >
                                        Cancel
                                    </button>
                                    <button
                                        ...
                                        className="flex-1 rounded-xl bg-[#1e40af] py-3 text-[10px] font-black uppercase text-white shadow-lg"
                                    >
                                        Delete
                                    </button>
                                </div>
